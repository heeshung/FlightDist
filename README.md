...
**Note: Versions _before_ v1.7.1 cannot use the ```update``` function due to a new directory structure.  Please manually download and install v1.7.1 or later if coming from 1.7.0 or earlier.**
